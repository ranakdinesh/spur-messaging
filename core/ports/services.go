...
type MessagingGateway interface {
	Submit(ctx context.Context, tenantID uuid.UUID, req MessagingRequest) (*MessagingReceipt, error)
	GetResult(ctx context.Context, tenantID, messageID uuid.UUID) (*MessagingResult, error)
}
